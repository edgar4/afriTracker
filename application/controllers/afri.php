...
class Afri extends CI_Controller {
	...
	{$this->load->model('afri_model');
			$record['records'] = $this->afri_model->getLast();
	...
	public function addRecord(){
		...
		if($this->form_validation->run()==false){
			...
			$this->load->model('afri_model');
			$this->afri_model->add_record($data);
...
public function showRecord(){
	$this->load->model('afri_model');
			$record['records'] = $this->afri_model->show_records();
...
public function allRecord(){
	...
	if($query=$this->afri_model->allRecord()){
...
public function updateRecord(){
	$this->load->model('afri_model');
	$template = array();
	if($query=$this->afri_model->update_selected()){
		...
		if($this->form_validation->run()==false){
			...
			$this->afri_model->update_record($data);
			$this->edit();
		}
}
function find(){
